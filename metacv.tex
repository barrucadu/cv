...
\entry{\orange{Jun~2019}}{Senior Developer}
  {\begin{tightitemize}
    \item Tech lead on a small team doing discovery work into GOV.UK
      Accounts: lots of \keyword{OAuth} and \keyword{OpenID Connect}.
    \item Planned, and then worked across teams to achieve, holistic
      improvements to GOV.UK.
    \item Worked with performance analysts to plan and run A/B tests.
...
\entry{\range{Apr~2018}{Jun~2019}}{Developer}
  {\begin{tightitemize}
    \item Evidence-driven improvements to the GOV.UK stack, both
      performance improvements and also resolving long-standing
