...
\entry[Government Digital Service]{\orange{Apr~2018}}
  {Developer}
  {\begin{tightitemize}
    \item Platform Health team: improving the health of GOV.UK through
      a combination of proactive interventions and reactive fixes.
    \item Maintained a distributed system formed of a large collection
      of \keyword{Rails 5} applications running in \keyword{AWS EC2}.
    \item Managed virtual machines through \keyword{Terraform} and
      \keyword{Puppet}.
    \end{tightitemize}}
...
\smallentry{CoCo}{2017}{\githublink{barrucadu}{coco}}
