...
\begin{cvtable}
  ...
  \detail{Testing of functional correctness for concurrent
    ...
    by removing it from the picture by overriding the concurrency
    primitives and implementing that bit of the runtime ourselves.}\\
  ...
  \detail{A concurrent IRC bot capable of connecting to multiple
    ...
    they arise. Also written in support of this were libraries for
    implementing an
    \schref{https://github.com/barrucadu/irc-client}{irc client},
    communicating with
    \schref{https://github.com/barrucadu/irc-conduit}{irc servers},
    and encoding \schref{https://github.com/barrucadu/irc-ctcp}{CTCP}
    messages.}
\end{cvtable}
