...
\section{Personal}
\cvtable
  \rowhead{Address} 5 Wilsthorpe Grove, York, North Yorkshire, England, YO10 4HU \\
  \rowhead{Website} \hhref{www.barrucadu.co.uk} \\
  \rowhead{Email}   \mhref{mike@barrucadu.co.uk} \\
  \rowhead{Phone}   (+44) (0) 7966875255 \\
  \rowhead{GPG Key} 9F58FC68
\cvtableend
...
\cvtable
  ...
  \rowdetail{Ongoing, due to enter second year in October of 2011.} \details{csyork}\\

  \rowhead{2009 - 2010} A Levels, \textbf{Hymers College}, UK\\
  \rowdetail{Achieved grade A in Further Mathematics, Mathematics, and Physics. Achieved grade C in ICT.}\\

  \rowhead{2009 - 2010} AS Levels, \textbf{Hymers College}, UK\\
  \rowdetail{Achieved grade A in Computing. Achieved grade C in Psychology.}
\cvtableend

\section{Computer Skills}
\cvtable
  \rowhead{Basic}       Autotools, Javascript, ML, Scheme, Subversion\\
  \rowhead{Familiar}    Apache, Bash, C, Java, {\fb\LaTeX}, Git, Microsoft Windows, MySQL, SQL\\
  \rowhead{Experienced} CSS, GNU/Linux, GNU/Hurd, PHP, Python, XHTML, Zsh
\cvtableend

\section{References}
\begin{tabular}{c}
  Dr Dimitar Kazakov Msc, PhD\\
  Academic supervisor\\
  \mhref{kazakov@cs.york.ac.uk}\\
\end{tabular}

\section{Interests}
Free and Open Source Software, Programming, Operating Systems, Computer Architectures 19th and 20th Century Literature and Literary Movements, Abstract Strategy Games
