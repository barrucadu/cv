...
\begin{cventry}{\orange{Mar~2022}}{Software Development Engineer}
  \begin{tightitemize}
    \item Worked on improving scalability of a key part of our API:
      ...
      \begin{itemize}
      \item Designed a \keyword{table partitioning} strategy to remove expensive queries.
      ...
      \end{itemize}
  \item Used \keyword{event sourcing} and \keyword{two-phase commit} to orchestrate distributed systems.
